(function () {
  ...
  const RU = {
    ...
    '📱 Allow screen rotation': '📱 Разрешить поворот экрана',
    'When off, BananZa tries to keep the mobile UI in portrait mode on supported browsers.': 'Если выключено, BananZa попробует удерживать мобильный интерфейс в портретном режиме в поддерживаемых браузерах.',
    'Screen rotation allowed': 'Поворот экрана разрешен',
    'Portrait lock is active': 'Портретная фиксация включена',
    'Screen rotation lock is not supported by this browser': 'Этот браузер не поддерживает фиксацию поворота экрана',
    'Tap once in the app to finish locking the screen': 'Тапните один раз в приложении, чтобы завершить фиксацию экрана',
    'Could not lock screen rotation': 'Не удалось зафиксировать поворот экрана',
    'Theme': 'Тема',
    '🎨 Theme': '🎨 Тема',
