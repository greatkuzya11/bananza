  ...
  function createShellRuntimeAdapter(scope = {}) {
    with (scope) {
      ...
      function createRuntimeEventScope() {
        ...
        if (!names.includes('handleComposerHistoryKeydown')) names.push('handleComposerHistoryKeydown');
        if (!names.includes('mapSettingsController')) names.push('mapSettingsController');
        if (!names.includes('mapSettingsFactory')) names.push('mapSettingsFactory');
        if (!names.includes('composerLocationController')) names.push('composerLocationController');
        if (!names.includes('composerLocationFactory')) names.push('composerLocationFactory');
