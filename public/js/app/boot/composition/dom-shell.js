  ...
  compositionRoot.composeDomShell = function composeDomShell(scope = {}) {
    with (scope) {
      ...
      const {
        ...
        documentInviteStatus,
        documentToolbar,
        documentEditor,
        copyDocumentInviteLinkBtn,
        refreshDocumentInviteLinkBtn,
        messagesEl,
        loadMoreWrap,
        loadMoreBtn,
        loadMoreAfterWrap,
