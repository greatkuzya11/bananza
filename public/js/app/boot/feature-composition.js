(function () {
  ...
  function composeFeatureRuntime(scope = {}) {
    ...
    with (scope) {
      ...
      publishRuntimeApi(legacyUiRuntimeApi);
      ...
      publishRuntimeApi(legacyShellRuntimeApi);
