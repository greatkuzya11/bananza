  ...
  function createRuntimeCore(scope = {}) {
    with (scope) {
      ...
      const {
        ...
        isPinEventDisplayed, systemEventIdKey, rememberSystemEvent, isSystemEventDisplayed,
        filterNewPinEvents, filterNewSystemEvents, timelineTimestamp, buildTimelineItems, renderPinSystemEvent, renderChatSystemEvent,
        buildMessagesFragment, replaceRenderedMessages, primeAppendedMessageSideEffects, appendTimelineItems,
        appendPinEventIfVisible, appendSystemEventIfVisible, isCurrentMessageRow, messageHasDeferredMediaLayout, clearPendingMediaBottomScroll,
