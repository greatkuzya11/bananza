...
## How to add features
- Любой новый видимый текст в `index.html`, `login.html`, `sw.js` и клиентских скриптах должен иметь русский и английский вариант в `public/js/i18n.js`. Для статического DOM используй `data-i18n*` там, где текст не покрывается общим переводчиком.
