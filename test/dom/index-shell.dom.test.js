...
test('public/index.html keeps expected stylesheet and script order', () => {
  ...
  assert.deepEqual(styles, [
    ...
    '/css/voice.css',
    '/css/telegram-transcription.css?v=20260819-telegram-bots2',
    '/css/video-notes.css',
  ]);
  ...
  assert.deepEqual(scripts, [
    ...
    '/js/messageCache.js',
    '/js/ai-image-risk.js',
    '/js/i18n.js?v=20260819-telegram-bots1',
    ...
    '/js/app/feature-registry.js?v=20260705-api-tokens',
    ...
    '/js/app/folders/ui.js?v=20260710-folder-strip-scroll2',
    ...
    '/js/app/folders/mobile-gestures.js?v=20260708-folder-mouse-swipe',
    ...
    '/js/app/boot/composition/admin-settings-composition.js?v=20260705-api-tokens',
    ...
    '/js/voice.js',
    '/js/telegram-transcription.js?v=20260819-telegram-bots1',
  ]);
});
